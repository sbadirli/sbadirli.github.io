...
$(document).ready(function() {
    ...
    function e(t) {
        ...
        return o > e ? "rgb(200,200,200)" : s > e ? "white" : n > e ? "rgb(200,200,200)" : i > e ? "white" : "rgb(200,200,200)"
    }
    function o(t) {
        var e = ($(window).scrollTop(), t),
            o = ($(".about").offset().top, $(".education").offset().top),
            ...
            n = ($(".experience").offset().top, $(".projects").offset().top),
            i = $(".projects").offset().top + $(".projects").height() + 80;
        return o > e ? "black" : s > e ? "rgb(200,200,200)" : n > e ? "black" : i > e ? "rgb(200,200,200)" : "black"
    }
    function s() {
        var t = $(window).scrollTop();
    ...
    $(window).bind("scroll", function(e) {
        ...
        jQuery.get(s, function(s) {
            ...
            "undefined" != typeof e && (n = n.attr("id", e)), "undefined" != typeof o && (n = n.attr("class", o + " replaced-svg")), n = n.removeAttr("xmlns:a"), t.replaceWith(n)
        }, "xml")
    });
    var n = !1;
    if (!n) {
        for (var i = Math.floor($("#edus").width() / 2) - 40, r = $(".courses"), a = 0; a < r.length; a++) {
            $(r[a]).css({
                width: i + "px"
            });
            var c = 0;
            $(r[a]).children(".listWrapper").children(".courseListWrapper").each(function() {
            ...
            var d = $(r[a]).children(".listWrapper").children(".courseListWrapper").length;
            $(r[a]).children(".listWrapper").css({
                height: c + "px",
                width: d * i + "px",
                "min-height": l + "px"
            });
            for (var p = $(r[a]).children(".listWrapper").children(".courseListWrapper"), h = 0; h < p.length; h++)
                $(p[h]).css({
                    width: i + "px",
                    height: c + "px",
                    "min-height": l + "px"
    ...
    $(".showCourses").click(function() {
        ...
        if ("Show Courses" == t) {
            $(".showCourses").children("p").text("Show Courses"), $(".courses").css({
                opacity: "0",
                left: "-100%"
            }), u = 1, $(this).children("p").text("Hide Courses");
    ...
    $(".courseRight").click(function() {
        ...
        $(this).parent().siblings(".listWrapper").css({
            transform: "translateX(" + (u - 1) * e * -1 + "px)"
        }), $(this).siblings("p").text("Semester " + u)
    ...
    x(), $(window).resize(x);
    var k = function() {
        $.browser.mozilla && ($(".eduPeriscope > div").removeClass("schoolImg"), $(".eduPeriscope").css({
    ...
    var T = function() {
        ...
        -1 != t.indexOf("safari") && -1 == t.indexOf("chrome") && $("#resume").css({
            "border-radius": "2px"
        })
    };
    T(), $(document).scroll(s)
